...
export default function HowTo() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-teal-400 to-indigo-400 flex flex-col items-center justify-start pt-8">
            <div className="bg-gray-900/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border-2 border-indigo-400/50 w-96 mb-4">
            <h1 className="text-white text-2xl font-bold mb-4">How to Play</h1>
